            ...
            <div class="email-template__card">
                <div class="email-template__card-limit">
                    <div class="email-template__description">
                        <br>
                        <p class="color--gray">Hi {$fname},</p>
                        <p class="color--gray">Thank you for sending us your thoughts. This is a quick note to let you know that we have received your message.</p>
                        <br>
                        <br>
                        <p class="color--gray">Best regards,</p>
                        <p class="color--gray">Thermal Solutions</p>
                    </div>
                </div>
            </div>
        </div>
